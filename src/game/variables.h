...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "CrcMD", CFGFLAG_SAVE|CFGFLAG_SERVER, "Game type (dm, tdm, ctf, lms, lts)")
...
MACRO_CONFIG_INT(DbgDummies, dbg_dummies, 32, 0, MAX_CLIENTS, CFGFLAG_SERVER, "")
